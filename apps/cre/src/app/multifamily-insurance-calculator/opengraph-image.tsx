...
export const alt =
  "Multifamily insurance impact calculator: NOI, cap rate value, DSCR, and cost per unit.";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

const METRICS = ["Cost per unit", "% of EGI", "Value at your cap", "DSCR headroom"];
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          >
            What your insurance is doing to NOI, value, and DSCR.
          </div>
