...
export const alt =
  "Wind and hail deductible calculator: per-location retention, one-storm exposure, and buy-down value.";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

const METRICS = ["Per location", "Per storm", "Per season", "Buy-down value"];
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          >
            A 5% wind deductible is not 5% of the loss.
          </div>
