...
// own — a link to the About page posted without a card just shows the homepage.
export const alt = "About Dan Wentz, commercial real estate insurance broker at ACREInsure.";
