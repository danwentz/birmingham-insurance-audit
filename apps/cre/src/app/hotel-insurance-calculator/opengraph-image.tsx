...
export const alt =
  "Hotel insurance calculator: cost per available room, per key, EBITDA impact, and value at your cap rate.";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

const METRICS = ["Per available room", "Per key", "% of revenue", "Value per key"];
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          >
            Your insurance, priced in RevPAR.
          </div>
